      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div
          className={`flex items-center justify-between rounded-full transition-all duration-500 ${
            scrolled
              ? "bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl shadow-black/50 px-6 py-3"
          ...
          <nav className="hidden lg:flex items-center gap-2 relative z-10">
            {NAV_LINKS.map((link) => (
              <a
                ...
                className="relative px-4 py-2 text-sm font-medium text-gray-300 hover:text-white transition-colors rounded-full hover-target group"
              >
                {link.label}
            ...
            <a
              href="/admin/login"
              className="px-4 py-2 text-sm font-semibold text-gray-300 hover:text-white hover-target transition-colors"
            >
              Login
            </a>
            <motion.a
            ...
            >
              ...
              <div className="relative flex items-center gap-2 px-5 py-2.5 bg-black rounded-full transition-colors group-hover:bg-emerald-950/50">
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="absolute top-full left-4 right-4 mt-2 lg:hidden bg-[#0a0a0a]/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
          >
            <div className="px-4 py-6 space-y-2">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileOpen(false)}
                className="flex items-center justify-center gap-2 w-full px-4 py-3 text-base font-semibold bg-emerald-600/20 text-emerald-400 hover:bg-emerald-600/30 border border-emerald-500/30 rounded-xl transition-colors"
              >
